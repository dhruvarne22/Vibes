       ...
       ${!uploadedImage ? 'h-[655px]' : 'h-[580px]'}
        `}>
                    ...
                    <div className={`h-[calc(500px-200px)] ${!uploadedImage ? 'mt-16' : 'mt-[58px]'}`}>
                        {!uploadedImage ? (
                            <div >
                                <div id="ProfiePhotoSection" className="flex flex-col border-b sm:h-[118px] h-[145px] px-1.5 py-2 w-full">
                                    ...
                                    <div className="flex items-center justify-center sm:-mt-6">
                                        ...
                                        <input type="file"
                                            className="hidden" id="image" onChange={getUploadedImage} accept="image/png, image/jpeg, image/jpg"
                                        />
                    ...
                    >
                        {!uploadedImage ? (
                            <div id="UpdatInfoButtons" className="flex items-center justify-end">
                                <button
                                    disabled={isUpdating}
                                    onClick={()=>setIsEditProfileOpen(false)}
