...
export default function MenuItemFollow({user}:MenuItemFollowCompTypes){
   return(
    ...
    <>
    <Link href={`/profiel/${user?.id}`} className="flex items-center hover:bg-gray-100 rounded-md w-full py-1.5 px-2">
<img src={useCreateBucketUrl( user?.image)} className="rounded-full lg:mx-0 mx-auto" width="35"  />
