                    ...
                    <div className="mt-8 md:flex gap-6">
                        {!fileDisplay ? (
                            ...
                            >
                                ...
                                <input type="file" onChange={onChange} hidden id="fileInput" accept=".mp4" />
                            </label>
                        ) : (
                            <div
                            ...
                            >
                                ...
                                <img src="/images/mobile-case.png" className="absolute pointer-events-none z-20" />

                                <img src="https://upload.wikimedia.org/wikipedia/en/a/a9/TikTok_logo.svg" className="absolute right-4 bottom-6 z-20" width="90" />
                                <video
                                    autoPlay
                                    loop
                                    muted
                        ...
                        <div className="mt-4 mb-6">
                            ...
                            <div>
                                <div className="text-bold text-[15px] mb-1.5">Divide videos and edit</div>



                                <div className="text-semibold text-[13px] text-gray-400">
                                    You can edit, remove unwanted parts, change orientation of your video and post your best video with Vibe.
                                </div>
                                </div>
                            ...
                            <div className="mt-5">
                                ...
                                <input 
                                maxLength={150}
                                className="w-full border p-2.5 rounded-md focus:outline-zone"
                                type="text"
                                value={caption}
